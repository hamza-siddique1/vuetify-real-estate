      ...
      <div v-show="activeTab === 'adv'">
        ...
        <div class="adv-section">
          ...
          <div class="price-labels">
            ...
            <span style="text-align:right">max<br><strong>{{ slider.hi >= 99 ? '$5M+' : fmtPriceShort(priceMax)
                }}</strong></span>
          </div>
        </div>
          ...
          <div class="adv-row">
            <div class="adv-col">
              <div class="year-built-box">
                <span>From</span>
                <input type="number" v-model.number="localFilters.yearFrom" placeholder="Any" min="1900" max="2026"
                  @change="emitChange">
              </div>
            </div>
            <div class="adv-col">
              <div class="year-built-box">
                <span>To</span>
                <input type="number" v-model.number="localFilters.yearTo" placeholder="2026" min="1900" max="2026"
                  @change="emitChange">
              </div>
            </div>
          </div>
